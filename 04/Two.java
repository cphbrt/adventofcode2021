...
/*
Hilariously, only two lines needed to be changed from One.java.
Reverse bestBoardTime to Integer.MIN_VALUE and flip the < to > in round compared to bestBoardTime!
*/
public class Two {
	...
	public static void main(String[] args) {
		...
		int bestBoardTime = Integer.MIN_VALUE;
